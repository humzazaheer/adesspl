...
@section('content')
    ...
    <section class="banner  fabrication-&-plant-eraction-banner">
            ...
            <div class="row">
                <div class="col-md-6 col-xl-3 mb-4">
                    <div class="card text-center waves-effect">
                        ...
                        <div class="card-body">
                        <br>
                            <h5 class="font-weight-normal">SS, CS, MS & Alloy Piping</h5>
                ...
                <div class="col-md-6 col-xl-3 mb-4">
                    <div class="card text-center waves-effect">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="font-weight-normal">Erection of Vessels, Tanks, Columns,
                                Stacks, Silos
                            </h5>
                ...
                <div class="col-md-6 col-xl-3 mb-4">
                    <div class="card text-center waves-effect">
                        ...
                        <div class="card-body">
                            <br>
                            <h5 class="font-weight-normal">Conveyers, Hoppers & weighing Systems</h5>
                ...
                <div class="col-md-6 col-xl-3 mb-4">
                    <div class="card text-center waves-effect ">
                        ...
                        <div class="card-body">
                            <br>
                            <h5 class="font-weight-normal">Steel Structures, Platforms & Staging</h5>
