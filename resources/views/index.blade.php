...
{{--                                <strong>Learn Bootstrap 4 with MDB</strong>--}}
    ...
    <section class="why-aldin">
        <div class="container ">
            <h1 class="text-center ad-black wow fadeInDown">Why ADESSPL?</h1>
    ...
    <section class=" core-values section-highlight">
        <div class="container">
            <h1 class="text-center ad-black wow fadeInDown">Core Values</h1>

            <div class="row my-5">
                <div class="col-lg-8 mx-auto">

                    <ol class="timeline">
                        <li class="timeline-element wow fadeInLeft">
    ...
    <section id="clients" class="our-clients container-fluid">
        ...
        <h1 class="text-center ad-black wow fadeInDown">Our Clients</h1>
