...
@section('content')
    ...
    <div class="container">
        <section class="ss-section mt-5 text-center">
            ...
            <p class=" wow fadeInUp"><strong>ADSSPL</strong> management team possesses vast experience of plan, manage, execute large number of turnaround
            ...
            <div class="row">
                ...
                <div class="col-lg-6 plant-img">
                    <div class="waves-light  wow zoomIn">
                        ...
                        <img src="{{asset('images/solution&services/plant-maintenance/electrical.JPG')}}"
                             class="img-fluid rounded"/>
                    </div>
                </div>
                </div>
