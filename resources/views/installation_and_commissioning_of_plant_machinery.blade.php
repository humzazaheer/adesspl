...
@section('content')
    ...
    <div class="container">
        <section class="ss-section">
            <h1 class="text-center mb-5 ad-black wow fadeInDown">Installation & Commissioning of Plant Machinery</h1>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="ss-img waves-light flipInY wow">
            ...
            <div class="row mt-4">
                ...
                <div class="col-lg-6 waves-light installation-img wow zoomIn">
